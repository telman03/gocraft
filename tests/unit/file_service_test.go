...
func TestFileService_GetFilePath(t *testing.T) {
	basePath := "/tmp/test"
	fileService := services.NewFileService(basePath, 30*24*time.Hour)
...
func TestFileService_FileOperations(t *testing.T) {
	...
	fileService := services.NewFileService(tempDir, 1*time.Hour)
...
func TestFileService_IsFileExpired(t *testing.T) {
	...
	fileService := services.NewFileService(tempDir, 1*time.Millisecond)
...
func TestFileService_GenerateSecureFilePathUniqueness(t *testing.T) {
	...
	fileService := services.NewFileService(tempDir, 30*24*time.Hour)
...
func TestFileService_ConfigurationMethods(t *testing.T) {
	...
	fileService := services.NewFileService(tempDir, initialMaxAge)
