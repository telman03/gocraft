...
func setupTestEnvironment(t *testing.T) {
	...
	history.Get("/", GetProjectHistory)
	history.Post("/duplicate", DuplicateProject)
	history.Get("/stats", GetProjectStats)
	history.Get("/dashboard", GetDashboardData)
	
	// Routes with project ID parameter (need ownership validation)
	history.Get("/:id", middleware.ProjectOwnershipValidator(), GetProjectDetails)
	history.Delete("/:id", middleware.ProjectOwnershipValidator(), DeleteProject)
	history.Get("/:id/download", middleware.ProjectOwnershipValidator(), DownloadProject)
	history.Post("/:id/regenerate", middleware.ProjectOwnershipValidator(), RegenerateProject)
